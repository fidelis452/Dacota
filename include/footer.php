    ...
    <div class="container footer-inner">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        <li>
                            Address: Kenya, Nyeri County, Tetu
                        </li>
                        <li>
                            Email: <a href="mailto:davidcharles81@gmail.com">davidcharles81@gmail.com</a>
                        </li>
                        <li>
                            Phone: <a href="tel:+2547 2316 0094">+2547 2316 0094</a>
                        </li>
                    </ul>
            ...
            <div class="recent-posts footer-item">
                    ...
                    <div class="media mb-4">
                        <a href="properties-details.html">
                            <img src="assets/img/doc.jpg" alt="doc">
                        </a>
                        <div class="media-body align-self-center">
                            <h5>
                                <a href="properties-details.html">Beautiful Residential rooms</a>
                            </h5>
                            <p>May 16, 2020</p>
                            <p> <strong>Ksh 8000/month</strong></p>
                        </div>
                    </div>
                    <div class="media mb-4">
                        <a href="properties-details.html">
                            <img src="assets/img/doc1.jpg" alt="doc2">
                        </a>
                        <div class="media-body align-self-center">
                            <h5>
                                <a href="properties-details.html">Spacious Commercial Rooms</a>
                            </h5>
                            <p>May 16, 2020</p>
                            <p> <strong>Ksh 5000/month</strong></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="copyright">
                            ...
                            </script> Dacota <i class="fa fa-heart-o" aria-hidden="true"></i>
            </div>
            </div>
        </div>
    </div>
